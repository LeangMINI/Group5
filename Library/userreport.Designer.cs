...
namespace Library {
    ...
    public partial class userreport : global::System.Data.DataSet {
        ...
        public partial class TBLUSERDataTable : global::System.Data.TypedTableBase<TBLUSERRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TBLUSERRow AddTBLUSERRow(decimal USERID, string USERNAME, decimal PASSWORD, string GENDER, System.DateTime DOB, string POB, string PHONE, string ADDRESS, byte[] PHOTO) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TBLUSERRow FindByUSERID(decimal USERID) {
        ...
        public partial class TBLUSERRow : global::System.Data.DataRow {
            ...
            public decimal USERID {
                get {
                    return ((decimal)(this[this.tableTBLUSER.USERIDColumn]));
                }
                set {
            ...
            public decimal PASSWORD {
                get {
                    return ((decimal)(this[this.tableTBLUSER.PASSWORDColumn]));
                }
                set {
            ...
            public string POB {
                get {
                    try {
                        return ((string)(this[this.tableTBLUSER.POBColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'POB\' in table \'TBLUSER\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTBLUSER.POBColumn] = value;
                }
            }
            ...
            public byte[] PHOTO {
                get {
                    try {
                        return ((byte[])(this[this.tableTBLUSER.PHOTOColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                ...
                set {
                    this[this.tableTBLUSER.PHOTOColumn] = value;
                }
            }
            ...
            public bool IsPOBNull() {
                return this.IsNull(this.tableTBLUSER.POBColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetPOBNull() {
                this[this.tableTBLUSER.POBColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public bool IsPHOTONull() {
                return this.IsNull(this.tableTBLUSER.PHOTOColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetPHOTONull() {
                this[this.tableTBLUSER.PHOTOColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Library.userreportTableAdapters {
    ...
    public partial class TBLUSERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM ""LIBRARY"".""TBLUSER"" WHERE ((""USERID"" = :Original_USERID) AND (""USERNAME"" = :Original_USERNAME) AND (""PASSWORD"" = :Original_PASSWORD) AND (""GENDER"" = :Original_GENDER) AND ((:IsNull_DOB = 1 AND ""DOB"" IS NULL) OR (""DOB"" = :Original_DOB)) AND ((:IsNull_POB = 1 AND ""POB"" IS NULL) OR (""POB"" = :Original_POB)) AND (""PHONE"" = :Original_PHONE) AND (""ADDRESS"" = :Original_ADDRESS))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::Oracle.ManagedDataAccess.Client.OracleParameter();
            param.ParameterName = "IsNull_POB";
            param.DbType = global::System.Data.DbType.Int32;
            param.OracleDbTypeEx = global::Oracle.ManagedDataAccess.Client.OracleDbType.Int32;
            param.Size = 100;
            param.IsNullable = true;
            ...
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::Oracle.ManagedDataAccess.Client.OracleParameter();
            param.ParameterName = "Original_POB";
            param.OracleDbTypeEx = global::Oracle.ManagedDataAccess.Client.OracleDbType.Varchar2;
            param.Size = 100;
            param.IsNullable = true;
            param.SourceColumn = "POB";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"LIBRARY\".\"TBLUSER\" (\"USERID\", \"USERNAME\", \"PASSWORD\", \"GENDER\", \"DOB" +
                "\", \"POB\", \"PHONE\", \"ADDRESS\", \"PHOTO\") VALUES (:USERID, :USERNAME, :PASSWORD, :G" +
                "ENDER, :DOB, :POB, :PHONE, :ADDRESS, :PHOTO)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""LIBRARY"".""TBLUSER"" SET ""USERID"" = :USERID, ""USERNAME"" = :USERNAME, ""PASSWORD"" = :PASSWORD, ""GENDER"" = :GENDER, ""DOB"" = :DOB, ""POB"" = :POB, ""PHONE"" = :PHONE, ""ADDRESS"" = :ADDRESS, ""PHOTO"" = :PHOTO WHERE ((""USERID"" = :Original_USERID) AND (""USERNAME"" = :Original_USERNAME) AND (""PASSWORD"" = :Original_PASSWORD) AND (""GENDER"" = :Original_GENDER) AND ((:IsNull_DOB = 1 AND ""DOB"" IS NULL) OR (""DOB"" = :Original_DOB)) AND ((:IsNull_POB = 1 AND ""POB"" IS NULL) OR (""POB"" = :Original_POB)) AND (""PHONE"" = :Original_PHONE) AND (""ADDRESS"" = :Original_ADDRESS))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        USERID, USERNAME, PASSWORD, GENDER, DOB, POB, PHONE, ADDRESS, PHOTO" +
                "\r\nFROM            \"LIBRARY\".TBLUSER";
        ...
        public virtual int Fill(userreport.TBLUSERDataTable dataTable) {
        ...
        public virtual userreport.TBLUSERDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            userreport.TBLUSERDataTable dataTable = new userreport.TBLUSERDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(userreport.TBLUSERDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(userreport dataSet) {
        ...
        public virtual int Delete(decimal Original_USERID, string Original_USERNAME, decimal Original_PASSWORD, string Original_GENDER, global::System.Nullable<global::System.DateTime> Original_DOB, string Original_POB, string Original_PHONE, string Original_ADDRESS) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((decimal)(Original_PASSWORD));
        ...
        public virtual int Insert(decimal USERID, string USERNAME, decimal PASSWORD, string GENDER, global::System.Nullable<global::System.DateTime> DOB, string POB, string PHONE, string ADDRESS, object PHOTO) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((decimal)(PASSWORD));
            if ((GENDER == null)) {
            ...
            if ((PHOTO == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[8].Value = ((object)(PHOTO));
            }
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((decimal)(PASSWORD));
            if ((GENDER == null)) {
                throw new global::System.ArgumentNullException("GENDER");
            }
            else {
            ...
            if ((PHOTO == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((object)(PHOTO));
            }
            this.Adapter.UpdateCommand.Parameters[9].Value = ((decimal)(Original_USERID));
            if ((Original_USERNAME == null)) {
                throw new global::System.ArgumentNullException("Original_USERNAME");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[11].Value = ((decimal)(Original_PASSWORD));
            if ((Original_GENDER == null)) {
                throw new global::System.ArgumentNullException("Original_GENDER");
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_PHONE, 
                    string Original_ADDRESS) {
            return this.Update(Original_USERID, USERNAME, PASSWORD, GENDER, DOB, POB, PHONE, ADDRESS, PHOTO, Original_USERID, Original_USERNAME, Original_PASSWORD, Original_GENDER, Original_DOB, Original_POB, Original_PHONE, Original_ADDRESS);
        }
    }
        ...
        public virtual int UpdateAll(userreport dataSet) {
            ...
            try {
                ...
                if ((this._tBLUSERTableAdapter != null)) {
                    ...
                    this._tBLUSERTableAdapter.Connection = ((global::Oracle.ManagedDataAccess.Client.OracleConnection)(workConnection));
                    this._tBLUSERTableAdapter.Transaction = ((global::Oracle.ManagedDataAccess.Client.OracleTransaction)(workTransaction));
                ...
                if ((this._tBLUSERTableAdapter != null)) {
                    this._tBLUSERTableAdapter.Connection = ((global::Oracle.ManagedDataAccess.Client.OracleConnection)(revertConnections[this._tBLUSERTableAdapter]));
